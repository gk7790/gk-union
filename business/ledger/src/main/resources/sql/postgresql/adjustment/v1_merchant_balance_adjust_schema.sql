...
CREATE UNIQUE INDEX "uk_mba_order_no" ON "merchant_balance_adjust_order" ("tenant_id" ASC, "adjust_order_no" ASC);
CREATE INDEX "idx_mba_merchant_created" ON "merchant_balance_adjust_order" ("tenant_id" ASC, "merchant_id" ASC, "created_at" ASC);
CREATE INDEX "idx_mba_type_status" ON "merchant_balance_adjust_order" ("tenant_id" ASC, "adjust_type" ASC, "status" ASC, "created_at" ASC);
CREATE INDEX "idx_mba_journal" ON "merchant_balance_adjust_order" ("tenant_id" ASC, "ledger_journal_no" ASC);
CREATE INDEX "idx_mba_related_order" ON "merchant_balance_adjust_order" ("tenant_id" ASC, "related_order_no" ASC);
