...
CREATE TABLE `merchant`  (
  ...
  `timezone` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'UTC' COMMENT '商户时区',
...
CREATE TABLE `merchant_app`  (
  ...
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 1正常 2暂停 3停用',
  `sign_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'HMAC_SHA256' COMMENT '签名类型: HMAC_SHA256/MD5',
...
CREATE TABLE `merchant_fee_rule`  (
  ...
  `min_fee` decimal(24, 8) NOT NULL DEFAULT '0.00000000' COMMENT '最低手续费，0表示不设置最低手续费',
  `max_fee` decimal(24, 8) NOT NULL DEFAULT '0.00000000' COMMENT '最高手续费，0表示不设置最高手续费',
...
CREATE TABLE `merchant_notify_task`  (
  ...
  `task_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '通知任务编号',
  `biz_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务类型: PAYIN_ORDER/PAYOUT_ORDER等',
  `biz_id` bigint NOT NULL COMMENT '业务ID',
  `biz_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务编号',
  `event_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '通知事件: PAYIN_SUCCESS/PAYOUT_FAILED等',
...
CREATE TABLE `merchant_request_log`  (
  ...
  `biz_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '业务类型: PAYIN_ORDER/PAYOUT_ORDER/BALANCE/QUERY',
