...
CREATE TABLE `merchant` (
  ...
  `timezone` varchar(64) NOT NULL DEFAULT 'UTC' COMMENT '商户时区',
...
CREATE TABLE `merchant_app` (
  ...
  `app_env` varchar(16) NOT NULL DEFAULT 'PROD' COMMENT '应用环境: TEST/PROD',
  `status` tinyint NOT NULL DEFAULT 1 COMMENT '状态: 0禁用 1启用',
...
CREATE TABLE `merchant_fee_rule` (
  ...
  `direction` varchar(32) NOT NULL COMMENT '订单类型: PAYIN/PAYOUT',
