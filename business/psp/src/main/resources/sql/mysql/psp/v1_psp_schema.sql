...
CREATE TABLE `psp_callback_log`  (
  ...
  `biz_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '业务类型: PAYIN_ORDER/PAYOUT_ORDER/REFUND等',
...
CREATE TABLE `psp_request_log`  (
  ...
  `psp_id` bigint NOT NULL COMMENT 'PSP ID',
  `psp_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT 'PSP编码快照',
  `biz_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '业务类型: PAYIN_ORDER/PAYOUT_ORDER/QUERY/REFUND等',
  `biz_id` bigint NULL DEFAULT NULL COMMENT '业务ID',
