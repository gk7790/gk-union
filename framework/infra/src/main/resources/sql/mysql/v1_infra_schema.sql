...
CREATE TABLE `sys_login_ip_whitelist` (
  ...
  `subject_type` varchar(32) NOT NULL COMMENT 'login subject type: PLATFORM/TENANT/MERCHANT',
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='login IP whitelist';
