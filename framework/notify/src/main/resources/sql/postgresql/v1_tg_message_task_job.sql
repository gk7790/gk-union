...
VALUES
(2064290000000000008, 'telegram', 'tgMessageTask', 'SYSTEM_ALERT', '0/5 * * * * ?', 1, 'Telegram绯荤粺鍛婅鍙戦€?閲嶈瘯', NOW()),
(2064290000000000009, 'telegram', 'tgMessageTask', 'BUSINESS_NOTIFY', '0/10 * * * * ?', 1, 'Telegram涓氬姟閫氱煡鍙戦€?閲嶈瘯', NOW());
