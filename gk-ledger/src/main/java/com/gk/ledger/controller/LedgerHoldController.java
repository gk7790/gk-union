...
@Tag(name = "账务冻结")
@RestController
@RequestMapping("/ledger/hold")
@RequiredArgsConstructor
public class LedgerHoldController {
    ...
    @RequiresPermission("ledger:hold:page")
    ...
    @RequiresPermission("ledger:hold:info")
    public R<?> get(@PathVariable("id") Long id) {
        return R.ok(ledgerHoldService.get(id));
    }
}
