...
public interface LedgerPostingService {
     ...
     * 借贷分录：
     * PSP/CLEARING 借 settleAmount + feeAmount；历史/沙箱订单没有pspAccountId时回退 INTERNAL/CLEARING
     * MERCHANT/PENDING_SETTLE 贷 settleAmount
     * INTERNAL/FEE_INCOME 贷 merchantFeeAmount
     */
    LedgerPostingResult postPaySuccess(PaySuccessPostingRequest request);

    /**
     * SETTLE_RELEASE — 待结算释放至商户可用。
     * MERCHANT/PENDING_SETTLE 借 settleAmount
     * MERCHANT/AVAILABLE 贷 settleAmount
     */
