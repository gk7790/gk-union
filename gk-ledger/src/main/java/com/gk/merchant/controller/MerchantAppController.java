...
public class MerchantAppController {
    ...
    @RequiresPermission("merchant:app:page")
    ...
    @RequiresPermission("merchant:app:info")
    ...
    @RequiresPermission("merchant:app:save")
    ...
    @RequiresPermission("merchant:app:update")
    ...
    @RequiresPermission("merchant:app:delete")
