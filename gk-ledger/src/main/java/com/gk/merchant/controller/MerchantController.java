...
public class MerchantController {
    ...
    @RequiresPermission("merchant:page")
    ...
    @RequiresPermission("merchant:info")
    ...
    @RequiresPermission("merchant:save")
    ...
    @RequiresPermission("merchant:update")
    ...
    @RequiresPermission("merchant:delete")
