...
public class MerchantFeeRuleController {
    ...
    @RequiresPermission("payment:merchant-fee-rule:page")
    ...
    @RequiresPermission("payment:merchant-fee-rule:info")
    ...
    @RequiresPermission("payment:merchant-fee-rule:save")
    ...
    @RequiresPermission("payment:merchant-fee-rule:update")
    ...
    @RequiresPermission("payment:merchant-fee-rule:delete")
