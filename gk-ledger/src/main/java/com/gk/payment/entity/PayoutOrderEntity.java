...
public class PayoutOrderEntity extends SimpleEntity {
    ...
    private String payeeAccountHash;
    private String payeeBankCode;
    private String payeeWalletType;
    private String payeePhoneCipher;
    private String payeePhoneMask;
    private String payeePhoneHash;
    private String payeeEmailCipher;
    private String payeeEmailMask;
    private String payeeEmailHash;
