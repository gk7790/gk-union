...
public class PspCallbackBodyCachingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        // 原始 body 通过 request attribute 暴露�?Controller/Service，避免重复读流失败�?        wrapped.setAttribute(ATTR_RAW_BODY, new String(wrapped.body, StandardCharsets.UTF_8));
