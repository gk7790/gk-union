 ...
 * PSP 回调请求体缓存过滤器。
 * <p>
 * Servlet 原始 inputStream 默认只能读取一次，PSP 回调既要验签又要解析参数和落日志，
 * 因此这里提前缓存 body，并包装成可重复读取的请求对象。
 */
@Component
public class PspCallbackBodyCachingFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response, FilterChain filterChain)
        ...
        // 原始 body 通过 request attribute 暴露给 Controller/Service，避免重复读流失败。
