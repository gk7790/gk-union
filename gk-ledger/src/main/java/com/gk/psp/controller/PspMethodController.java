...
public class PspMethodController {
    ...
    @RequiresPermission("psp:method:page")
    ...
    @RequiresPermission("psp:method:info")
    ...
    @RequiresPermission("psp:method:save")
    ...
    @RequiresPermission("psp:method:update")
    ...
    @RequiresPermission("psp:method:delete")
