...
public class PspRequestLogger {
     ...
     * 例如适配器缺失、网络异常、签名构造异常等，这类场景没有完�?PSP 响应�?     */
     ...
     * 代付通常先冻结商户余额，再提�?PSP；该日志可用于追踪冻结后是否成功请求上游�?     */
    ...
    /**
     * 记录代付主动查单正常返回的请求日志�?     * <p>
     * 查单结果后续会走�?PSP 回调类似的状态更新、账务扣冻结或解冻逻辑�?     */
    ...
    /**
     * 生成默认代收下单 URL�?     * <p>
     * 适配器没有明确返�?requestUrl 时，�?PSP baseUrl 拼出一个默认地址便于排查�?     */
    ...
    /**
     * 脱敏请求/响应文本�?     * <p>
     * 对常见密钥、token、签名字段做掩码，降�?PSP 请求日志泄露敏感信息的风险�?     */
