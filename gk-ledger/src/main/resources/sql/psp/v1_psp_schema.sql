...
CREATE TABLE `psp_account`  (
  ...
  `secret_type` varchar(32) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'HMAC' COMMENT '密钥类型: HMAC/RSA/BASIC/TOKEN',
  ...
  `merchant_private_key_ref` varchar(256) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '平台侧私钥引用',
  `psp_public_key` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL COMMENT 'PSP公钥',
