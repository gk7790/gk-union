...
CREATE TABLE `ledger_account`  (
  ...
  `account_type` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '账户类型: MERCHANT_AVAILABLE/MERCHANT_FROZEN/PSP_AVAILABLE/PSP_CLEARING等',
