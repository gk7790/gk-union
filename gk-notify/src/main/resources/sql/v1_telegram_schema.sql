...
CREATE TABLE `tg_chat`  (
  ...
  `event_types` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '订阅事件(逗号分隔, 空=不接收): SYSTEM_ERROR,SYSTEM_WARN,RISK_WARN,PAYIN_NOTICE,PAYOUT_NOTICE,CHANNEL_NOTICE,MERCHANT_NOTICE,ORDER_NOTICE,PSP_NOTICE',
...
CREATE TABLE `tg_message_task`  (
  ...
  `content` text CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL COMMENT '最终发送内容，已按parse_mode渲染完成',
