...
CREATE TABLE `payin_order`  (
  ...
  `psp_fee_amount` decimal(24, 8) NOT NULL DEFAULT 0.00000000 COMMENT '支付服务商成本手续费',
  `psp_fee_rule_id` bigint NULL DEFAULT NULL COMMENT '支付服务商成本手续费规则ID',
  `psp_fee_snapshot_json` json NULL COMMENT '支付服务商成本手续费规则快照JSON',
  ...
  `merchant_status_code` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '商户可见状态原因码',
  `merchant_status_reason` varchar(512) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '商户可见状态原因说明',
  ...
  `route_snapshot_json` json NULL COMMENT '订单最终路由命中快照JSON',
  ...
  `psp_method_id` bigint NULL DEFAULT NULL COMMENT '支付服务商支付方式ID',
  `psp_method_code` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '支付服务商支付方式编码',
  `psp_account_id` bigint NULL DEFAULT NULL COMMENT '支付服务商账户配置ID',
  `psp_account_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '支付服务商账户号快照',
  `psp_request_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '请求PSP的平台请求编号',
  `psp_order_no` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '支付服务商订单号',
  `psp_status` varchar(64) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '支付服务商状态',
  `psp_raw_status` varchar(128) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '支付服务商原始状态',
  `psp_pay_url` varchar(1024) CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NULL DEFAULT NULL COMMENT '支付服务商收银台/支付链接',
  `psp_pay_params_json` json NULL COMMENT '支付服务商支付参数JSON',
  `next_query_at` datetime(3) NULL DEFAULT NULL COMMENT '下一次主动查询支付服务商状态的时间',
  `query_count` int NOT NULL DEFAULT 0 COMMENT '主动查询支付服务商状态的次数',
